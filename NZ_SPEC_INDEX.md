...
|-----------|--------------------------|------------|-----------|
| NZ-0001   | NewZone Core             | draft v0   | 0.0.11    |
| NZ-0002   | Identity Format          | draft v0   | 0.0.11    |
| NZ-0003   | Communication Model      | draft v0   | 0.0.11    |
| NZ-0004   | Routing Protocol         | draft v0   | 0.0.11    |
| NZ-0005   | Storage Model            | draft v0   | 0.0.11    |
| NZ-0006   | Trust Graph              | draft v0   | 0.0.11    |
| NZ-0007   | Quantum Resilience       | draft v0   | 0.0.11    |
| NZ-0008   | Formal Verification Model| draft v0   | 0.0.11    |
| NZ-0009   | Message Envelope Format  | draft v0   | 0.0.11    |
| NZ-0010   | Payload Schema Definition| draft v0   | 0.0.11    |
